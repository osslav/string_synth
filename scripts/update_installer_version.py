...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MySynth Demo Installer\n"
      else:
        line="OutputBaseFilename=MySynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MySynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MySynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MySynth Demo installer\n"
     else:
       line="SetupWindowTitle=MySynth installer\n"
